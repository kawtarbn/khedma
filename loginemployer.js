// SELECT ELEMENTS
let Email = document.querySelector("#emailmp"),
    Password = document.querySelector("#passemp"),
...
Submit_Btn.addEventListener("click", (event) => {
    ...
    if (checkInputs()) {
        loginAsEmployer();  // only login if validation passes
    }
});
...
function loginAsEmployer() {
    localStorage.setItem("role", "employer"); // save role
